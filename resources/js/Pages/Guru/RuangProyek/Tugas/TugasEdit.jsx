...
export default function TugasEdit({ auth }) {
    ...
    const { data, setData, post, errors } = useForm({
        ...
        class_id: tugases.class_id,
        step_1: tugases.step_1,
        desc_1: tugases.desc_1,
        step_2: tugases.step_2,
        desc_2: tugases.desc_2,
        step_3: tugases.step_3,
        desc_3: tugases.desc_3,
        step_4: tugases.step_4,
        desc_4: tugases.desc_4,
        step_5: tugases.step_5,
        desc_5: tugases.desc_5,
        step_6: tugases.step_6,
        desc_6: tugases.desc_6,
    });
    ...
    const handleOnSubmit = (e) => {
        e.preventDefault();
        post(route("tugas-guru.update", tugases.id));
    };

    return (
        <AuthenticatedLayout authUser={auth.user} title="Ruang Proyek">
            <CreateTemplate title="EDIT PROYEK">
